...
\begin{definition}[Homeomorphism]
    Let $X$ and $Y$ be topological spaces. A \textbf{homeomorphism} is a bijective map $f: X \to Y$ such that both $f$ and $f^{-1}$ are continuous. If such a map exists, we say $X$ and $Y$ are \textbf{homeomorphic} and write $X \cong Y$.
\end{definition}
